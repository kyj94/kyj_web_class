		...
		<script>
			$(document).ready(function(){
				...
				$("#set_data").click(function(){
					...
					// 3. test 에서 hteml 태그를 추가하는 경우 --> html()
					/* $("#hobby").html("<li>게임하기</li>"); */
					
					
					// 4. append(html태그)					
					$("#hobby").append("<li>게임하기</li>").append("<li>노래하기</li>").append("<li>등산하기</li>").append("<li>영화보기</li>");
					
					// a태그 링크 형태로 d1에 추가하기
					$("#d1").html("<a href='http://www.naver.com'>naver</a>");
					
					// 이미지 추가하기 
					$("#d2").html("<img src='../images/logo.png'>");
					$("#d2 > img").css("width","30%");
				});
...
<body>
	...
	이미지 속성 가져오기(src 속성만) : <span id="s2"></span><br>
